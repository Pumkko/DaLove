...
import { TouchableOpacity, Text, SafeAreaView, TextInput, ActivityIndicator } from 'react-native';
...
export const UploadMemoryScreen: React.FC<UploadMemoryNavigationProp> =
  observer(({ navigation }: UploadMemoryNavigationProp) => {
      ...
      React.useLayoutEffect(() => {
          navigation.setOptions({
              headerRight: () => (
                  ...
                  >
                      <Text style={UploadMemoryStyle.nextStepText}>Next</Text>
                  </TouchableOpacity>
              ),
          });
      }, [navigation]);
